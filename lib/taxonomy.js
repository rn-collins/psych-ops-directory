...
export function descriptorFor(entry) {
  ...
  if (CLAIM_PATTERN.test(text)) return { text: "", withheld: true, reason: "the recorded descriptor contains a ranking, certification, superlative or transaction claim with no source attached" };
  return { text, withheld: false, reason: "" };
}
